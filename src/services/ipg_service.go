...
type IIpgService interface {
	RequestPayment(request *requests.CreatePaymentRequest) (interface{}, error)
...
func (service *IpgService) RequestPayment(request *requests.CreatePaymentRequest) (interface{}, error) {
	// IPG
